...
<html>
	...
	<body><div id="playerbg"></div><div id="container"><div id="container_2">
		...
		<div id="anchor">
			<a rel="bookmark" href='javascript:var matches = /(?:id|users\/view|profiles|search)(?:\/|\?q=)(.*?)\/?$/g.exec(window.location); if (matches != undefined) {window.open("http://steamid.billyvenner.xyz/?q=" + matches[1]);} else {alert("Could not find information in URL!");}'>SteamID Convert</a>
